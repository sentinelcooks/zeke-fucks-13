...
| File | When to read |
|------|--------------|
| [docs/Codex/sentinel-backend-rules.md](docs/Codex/sentinel-backend-rules.md) | Any backend logic, model/scoring, Edge Functions, API routes |
| [docs/Codex/ai-provider-routing.md](docs/Codex/ai-provider-routing.md) | Any AI text generation, analysis output, provider routing |
| [docs/Codex/supabase-edge-function-rules.md](docs/Codex/supabase-edge-function-rules.md) | Any Edge Function creation, editing, or deployment |
| [docs/Codex/deployment-safety-rules.md](docs/Codex/deployment-safety-rules.md) | Any multi-file change, migration, deploy, or Git push |
| [docs/Codex/codebase-memory-rules.md](docs/Codex/codebase-memory-rules.md) | Session hygiene, token efficiency, architecture decisions |
...
1. Add it to the appropriate `docs/Codex/` file
2. Add a summary line to the relevant section of this `AGENTS.md`
