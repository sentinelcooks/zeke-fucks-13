...
const GamesPage = () => {
  ...
  const FightCard = ({ fight, index }: { fight: UfcFight; index: number }) => {
    ...
    <motion.div {...stagger(index)} className="vision-card p-4 relative overflow-hidden">
      ...
      <div className="grid grid-cols-[auto_1fr_auto_1fr_auto] items-center gap-1.5 <div className="grid grid-cols-[auto_1fr_auto_1fr_auto] items-center gap-1.5 mt-2">">
