                ...
                {results.minutes_trend && results.minutes_trend.trend !== "insufficient_data" && (
                  <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="vision-card p-5 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-2.5 mb-3">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground/65">{prop.sport === "nhl" ? "TOI Trend" : "Minutes Trend"}</span>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-base font-bold text-foreground tabular-nums">{results.minutes_trend.avg_min} {prop.sport === "nhl" ? "TOI avg" : "min avg"}</p>
