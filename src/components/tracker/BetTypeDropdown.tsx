...
import {
  ...
  RotateCcw, Link2, Hash,
} from "lucide-react";

const SPORT_BET_TYPES: Record<string, { label: string; aliases: string[]; icon: typeof Target }[]> = {
  nba: [
    { label: "Points", aliases: ["pts", "pt", "scoring", "nba_points"], icon: Target },
    { label: "Rebounds", aliases: ["reb", "rebs", "rbs", "boards", "nba_rebounds"], icon: Shield },
    { label: "Assists", aliases: ["ast", "asts", "dimes", "nba_assists"], icon: Hand },
    { label: "3-Pointers", aliases: ["3pt", "3pm", "threes", "3s", "triples", "3-pt", "3 pointers", "3-pointers", "three pointers", "nba_3pt", "nba_3pm"], icon: Crosshair },
    { label: "Steals", aliases: ["stl", "stls", "nba_steals"], icon: Zap },
    { label: "Blocks", aliases: ["blk", "blks", "swats", "nba_blocks"], icon: Shield },
    { label: "Turnovers", aliases: ["to", "tov", "tovs", "turnover", "nba_turnovers"], icon: RotateCcw },
    { label: "Points + Rebounds", aliases: ["pr", "p+r", "p + r", "pts+reb", "pts + reb", "points rebounds", "points + rebounds", "nba_pts_reb"], icon: Gauge },
    { label: "Points + Assists", aliases: ["pa", "p+a", "p + a", "pts+ast", "pts + ast", "points assists", "points + assists", "nba_pts_ast"], icon: Gauge },
    { label: "Rebounds + Assists", aliases: ["ra", "r+a", "r + a", "reb+ast", "reb + ast", "rebounds assists", "rebounds + assists", "nba_reb_ast"], icon: Link2 },
    { label: "Points + Rebounds + Assists", aliases: ["pra", "pts+reb+ast", "pts + reb + ast", "p+r+a", "p + r + a", "points rebounds assists", "points + rebounds + assists", "combo", "pra combo", "nba_pra"], icon: Activity },
    { label: "Free Throws Made", aliases: ["ftm", "free throws", "free throws made", "free_throws", "nba_ftm", "nba_free_throws"], icon: CircleDot },
    { label: "Free Throw Attempts", aliases: ["fta", "free throw attempts", "free throws attempted", "ft attempts", "ft_attempts", "free_throw_attempts", "nba_fta"], icon: Hash },
  ...
  mlb: [
    ...
    { label: "Game Total", aliases: ["total", "o/u", "over under", "game o/u", "game total", "gt", "runs total"], icon: Activity },
    { label: "Moneyline", aliases: ["ml", "money line", "winner"], icon: Trophy },
  ...
  nhl: [
    ...
    { label: "Game Total", aliases: ["total", "o/u", "over under", "game o/u", "game total", "gt", "goals total"], icon: Activity },
    { label: "Moneyline", aliases: ["ml", "money line", "winner"], icon: Trophy },
  ...
  nfl: [
    ...
    { label: "Game Total", aliases: ["total", "o/u", "over under", "game o/u", "game total", "gt", "points total"], icon: Activity },
    { label: "Moneyline", aliases: ["ml", "money line", "winner"], icon: Trophy },
    { label: "Spread", aliases: ["ats", "against the spread", "handicap", "line"], icon: Star },
  ],
  other: [
