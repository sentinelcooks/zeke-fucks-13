...
const tabs = [
  ...
  { path: "/dashboard/nba", icon: BarChart3, label: "Analyze" },
...
const ROUTE_TAB_MAP: Record<string, string> = {
  ...
  "/dashboard/nba": "/dashboard/nba",
  "/dashboard/moneyline": "/dashboard/nba",
  "/dashboard/mlb-predictions": "/dashboard/nba",
  "/dashboard/ufc": "/dashboard/nba",
  "/dashboard/arbitrage": "/dashboard/nba",
