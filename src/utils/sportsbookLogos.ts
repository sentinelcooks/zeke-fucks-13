...
const SPORTSBOOK_DATA: Record<string, SportsbookInfo> = {
  ...
  caesars:     { label: "Caesars",     logo: "",             color: "#7c5cc4", abbrev: "CZ" },
  fanatics:    { label: "Fanatics",    logo: "",             color: "#2563eb", abbrev: "FA" },
  bet365:      { label: "bet365",      logo: "",             color: "#16a34a", abbrev: "B3" },
  hardrock:    { label: "Hard Rock",   logo: "",             color: "#eab308", abbrev: "HR" },
  sleeper:     { label: "Sleeper",     logo: "",             color: "#64748b", abbrev: "SL" },
